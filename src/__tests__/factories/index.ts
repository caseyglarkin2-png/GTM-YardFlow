...
export function createMockRailwaySequence(overrides: Partial<RailwaySequence> = {}): RailwaySequence {
  ...
  return {
    ...
    steps: [
      { id: generateId('step'), order: 0, type: 'email', subject: 'Step 1', body: 'First email', delayDays: 0 },
      { id: generateId('step'), order: 1, type: 'wait', delayDays: 3 },
      { id: generateId('step'), order: 2, type: 'email', subject: 'Step 2', body: 'Follow up', delayDays: 0 },
    ],
    status: 'active',
    enrollmentCount: 0,
